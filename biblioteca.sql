...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2023 a las 16:28:04
...
(1, 'pbkdf2_sha256$600000$ezSnMBO0EZxvxIzqLPgjA8$dMcYLvtnBkpbIvOmWQ4o0+KFGGTJCgg371rzXboYT4k=', '2023-10-27 13:46:44.634513', 1, 'gisell', '', '', 'egisell@gmail.com', 1, 1, '2023-10-26 14:09:20.327457');
...
INSERT INTO `libreria_libro` (`id_libro`, `titulo`, `autor`, `descripcion`, `fecha`, `cantidad`) VALUES
(1, 'La ilíada', 'Homero', 'La Ilíada es un poema de género épico que trata el asedio de la ciudad de Troya por los griegos para rescatar a Helena, esposa del rey Melando, la cual fue raptada por París, príncipe troyano.', 1892, 4),
(2, 'Fundamentos de programación', 'José Antonio Cerrada Somolinos, ‎Manuel E. Collado Machuca', 'El texto esta diseñado para poder seguir una asignatura de Fundamentos de Programación de primer curso de Grado en Informática, pero es un texto introductorio que puede seguir cualquier lector que tenga conocimientos generales de ...', 2010, 10),
(3, 'Programación para principiantes', 'Alexander Cane', 'Esto no es cualquier tipo de libro de programación que aprieta todo en un libro de 300 páginas; hay Wikipedia para eso! Programación para principiantes es una hoja de ruta para cualquier persona, joven o mayor, que busca una manera de ...', 2019, 2),
(8, 'php', 'esteban', 'php lenguaje', 2021, 9);
...
ALTER TABLE `libreria_libro_usuario`
  ...
  ADD KEY `libreria_libro_usuar_id_usuario_id_c9207ad2_fk_libreria_` (`id_usuario_id`);
...
--
ALTER TABLE `libreria_libro_usuario`
  MODIFY `id_libro_usuario` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `libreria_libro_usuario`
  ...
  ADD CONSTRAINT `libreria_libro_usuar_id_usuario_id_c9207ad2_fk_libreria_` FOREIGN KEY (`id_usuario_id`) REFERENCES `libreria_usuario` (`id_usuario`);
